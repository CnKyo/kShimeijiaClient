 ...
 */
- (NSDictionary*)getProductArgsDic
{
...
{
    NSError* error = nil;
    NSData *jsonData = [NSJSONSerialization dataWithJSONObject:[self getProductArgsDic] options:NSJSONWritingPrettyPrinted error: &error];
...
- (NSString *)genPackage{
    ...
    [params setObject:WXPAYURL forKey:@"notify_url"];
