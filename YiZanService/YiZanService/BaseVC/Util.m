...
+ (BOOL)isMobileNumber:(NSString *)mobileNum
{
    ...
    NSPredicate *newphonePre = [NSPredicate predicateWithFormat:@"SELF MATCHES %@",newPhone];
    ...
    if (([regextestmobile evaluateWithObject:mobileNum] == YES)
        ...
        || ([newphonePre evaluateWithObject:mobileNum] == YES)
